...
const FinishRide = () => {
  return (
    <div>
      ...
      <div className='flex items-center justify-between mt-4 border-2 border-yellow-200 rounded-lg p-4'>
      ...
      <div className='flex gap-2 justify-between items-center flex-col'>
        <div className='w-full mt-5'>
          ...
          <div className='mt-6 w-full'>
            <Link to='/captain-home' className='w-full flex justify-center mt-5 p-2 rounded-lg bg-green-600 text-white font-semibold'>
              Finish Ride
            </Link>
